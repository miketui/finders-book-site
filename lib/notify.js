 ...
 *
 * Env:
 *   CONTACT_NOTIFY_WEBHOOK_URL   optional; must be https. Unset = feature off.
 *
 * Always best effort: a failed alert must never turn a delivered message into an
 * error for the visitor who sent it.
 */
